...
//               <input type="text" name="name" placeholder="Your name" required className="block w-full h-10 rounded-md border border-gray-400 px-3 py-2 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-[#c73967] focus:border-[#c73967]" />
//             </div>
//             <div className="space-y-2">
...
//           {submitted && <p className="text-green-600 font-semibold transition-opacity">✅ Message sent successfully</p>}
//         </form>
//       </div>
//     </section>
//   );
